...
const wishList = [
  {
    title: "🌙 Gửi Bé Yêu",
    text: "Chúc Bé có một mùa Trung Thu thật vui vẻ, bình an và luôn được ở bên những người mà Bé yêu thương.",
    img: "./assets/1.jpg",
  },
  {
    title: "🏮 Ánh đèn đầu tiên",
    text: "Mong ánh đèn Trung Thu đêm nay sẽ soi sáng những điều tốt đẹp nhất đang chờ Bé ở phía trước.",
    img: "./assets/2.jpg",
  },
  {
    title: "✨ Một điều ước",
    text: "Nếu đêm nay Bé được ước một điều, hãy ước cho những điều Bé mong chờ nhất rồi sẽ trở thành hiện thực.",
    img: "./assets/3.jpg",
  },
  {
    title: "🌸 Mong Em luôn vui",
    text: "Mong nụ cười của Em sẽ luôn xuất hiện thật nhiều, không chỉ trong đêm Trung Thu mà cả những ngày bình thường.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌕 Ánh trăng",
    text: "Trăng đêm nay có thể rất đẹp, nhưng hy vọng Em vẫn tìm được một lý do để mỉm cười đẹp hơn cả ánh trăng.",
    img: "./assets/2.jpg",
  },
  {
    title: "💗 Điều nhỏ bé",
  ...
  {
    title: "🎑 Đêm Trung Thu",
    text: "Chúc Em một đêm Trung Thu thật dịu dàng, có ánh trăng, có tiếng cười và có thật nhiều kỷ niệm đẹp.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌷 Gửi một chút dịu dàng",
    text: "Mong những mệt mỏi trong lòng Em sẽ nhẹ đi, để đêm nay chỉ còn lại sự bình yên và những điều khiến Em vui.",
    img: "./assets/2.jpg",
  },
  {
    title: "⭐ Ngôi sao nhỏ",
    text: "Giữa hàng ngàn ánh sao trên bầu trời, mong Bé luôn nhớ rằng mình cũng là một người rất đặc biệt.",
    img: "./assets/3.jpg",
  },
  {
    title: "🏮 Chiếc đèn đỏ",
    text: "Chiếc đèn này mang theo một lời chúc nhỏ: mong mọi con đường Bé đi qua đều có ánh sáng dẫn lối.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌙 Bình yên nhé",
    text: "Mong những ngày sắp tới của Em sẽ thật nhẹ nhàng, ít muộn phiền và có nhiều khoảnh khắc khiến Em hạnh phúc.",
    img: "./assets/2.jpg",
  },
  {
    title: "💫 Một lời chúc",
    text: "Chúc Bé luôn đủ mạnh mẽ để bước tiếp, đủ dịu dàng để yêu thương và đủ may mắn để gặp những điều tốt đẹp.",
    img: "./assets/3.jpg",
  },
  {
  ...
  },
  {
    ...
    text: "Mong những ngày phía trước sẽ đối xử thật dịu dàng với Em, để Em luôn có lý do tin rằng cuộc sống này rất đáng yêu.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌕 Dưới ánh trăng",
    text: "Nếu có thể giữ lại một khoảnh khắc của đêm nay, mình mong đó sẽ là khoảnh khắc Em mỉm cười dưới ánh trăng.",
    img: "./assets/3.jpg",
  },
  {
    title: "💌 Một lá thư nhỏ",
    text: "Không biết Em có nhận ra không, nhưng có một người luôn mong Em được vui vẻ, bình an và hạnh phúc.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌸 Mong ước",
    text: "Mong những điều Em chưa nói thành lời sẽ có ngày được thực hiện, và những điều Em đang chờ đợi sẽ sớm tìm đến.",
    img: "./assets/2.jpg",
  },
  {
    title: "✨ Đêm thật đẹp",
    text: "Đêm nay trăng sáng, đèn lung linh và mọi thứ thật đẹp. Nhưng điều mình mong nhất vẫn là Em có một đêm thật vui.",
    img: "./assets/3.jpg",
  },
  {
    title: "💖 Gần bên nhau",
  ...
  {
    title: "🌙 Nếu Bé biết",
    text: "Nếu Bé biết có một người luôn âm thầm quan tâm đến Bé, liệu Bé có mỉm cười không?",
    img: "./assets/3.jpg",
  },
  {
    title: "🏮 Chiếc đèn thứ hai",
    text: "Mình gửi vào chiếc đèn này một chút yêu thương, một chút nhớ nhung và thật nhiều lời chúc dành cho Em.",
    img: "./assets/1.jpg",
  },
  {
    title: "💗 Điều muốn nói",
    text: "Có những lời không dễ nói thành câu, nên mình gửi chúng vào những chiếc đèn để Em tự mình khám phá.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌕 Trăng và Em",
    text: "Người ta thường nói trăng Trung Thu là đẹp nhất. Nhưng với mình, khoảnh khắc Em vui mới là điều đẹp nhất.",
    img: "./assets/3.jpg",
  },
  {
    title: "💌 Lá thư cuối",
    text: "Nếu Em đã mở đến chiếc đèn này, thì có lẽ Em đã đọc hết những điều mình muốn gửi.",
    img: "./assets/1.jpg",
  },
  {
    title: "❤️ Một điều thật lòng",
    text: "Mình không biết tương lai sẽ như thế nào, nhưng mình biết rằng hiện tại mình rất trân trọng sự xuất hiện của Em trong cuộc đời mình.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌷 Cảm ơn Em",
    text: "Cảm ơn Em vì đã xuất hiện, vì những khoảnh khắc vui vẻ và vì đã khiến những ngày bình thường trở nên đặc biệt hơn.",
    img: "./assets/3.jpg",
  },
  {
    title: "✨ Điều đặc biệt",
    text: "Có thể với thế giới Em chỉ là một người bình thường, nhưng trong thế giới của một người nào đó, Em lại là cả một bầu trời.",
    img: "./assets/1.jpg",
  },
  {
  ...
  {
    title: "🌸 Dịu dàng",
    text: "Nếu cuộc sống đôi khi quá mệt mỏi, hãy nhớ rằng vẫn có những người mong Em được bình yên và luôn muốn nhìn thấy nụ cười của Em.",
    img: "./assets/1.jpg",
  },
  {
    title: "🏮 Đèn và trăng",
  ...
  },
  {
    ...
    text: "Mình không mong Em có một cuộc sống hoàn hảo. Mình chỉ mong mỗi ngày Em đều có ít nhất một lý do để mỉm cười.",
    img: "./assets/1.jpg",
  },
  {
    title: "💖 Nếu có thể",
  ...
  },
  {
    ...
    text: "Trung Thu năm nay mình chỉ muốn gửi đến Em một lời chúc thật đơn giản: hãy luôn vui, luôn bình an và đừng quên rằng Em rất đáng được yêu thương.",
    img: "./assets/3.jpg",
  },
  {
    title: "❤️ Điều cuối cùng",
    text: "Nếu những chiếc đèn này có thể mang theo một lời nhắn đến Em, thì mình muốn chiếc đèn cuối cùng nói rằng: cảm ơn Em đã đến bên mình. Mong rằng dù sau này thời gian có trôi qua bao lâu, chúng ta vẫn sẽ nhớ về nhau bằng những điều thật đẹp.",
    img: "./assets/1.jpg",
  },
  {
    title: "💝 Gửi Em, người đặc biệt nhất",
    text: "Nếu Em đang đọc đến đây, thì đây chính là điều mình muốn nói nhất. Mình không biết tương lai sẽ đưa chúng ta đi đến đâu, nhưng mình thật sự mong rằng trên hành trình ấy, mình vẫn có thể được ở bên Em, cùng Em đón thêm thật nhiều mùa Trung Thu nữa. Không cần điều gì quá lớn lao, chỉ cần có Em bên cạnh, một ánh trăng, một chiếc đèn và một khoảnh khắc bình yên cũng đã đủ để mình cảm thấy hạnh phúc. Chúc Em luôn được yêu thương, luôn mỉm cười và nếu có thể... hãy cho mình một cơ hội để trở thành người khiến Em mỉm cười thật nhiều. ❤️",
    img: "./assets/2.jpg",
  },
];
