...
const wishList = [
  {
    title: "🌙 Gửi cậu",
    text: "Chúc cậu có một mùa Trung Thu thật vui vẻ, bình an và luôn được ở bên những người mà cậu yêu thương.",
    img: "./assets/1.jpg",
  },
  {
    title: "🏮 Ánh đèn đầu tiên",
    text: "Mong ánh đèn Trung Thu đêm nay sẽ soi sáng những điều tốt đẹp nhất đang chờ cậu phía trước.",
    img: "./assets/2.jpg",
  },
  {
    title: "✨ Một điều ước",
    text: "Nếu đêm nay cậu được ước một điều, hãy ước cho những điều cậu mong chờ nhất rồi sẽ trở thành hiện thực.",
    img: "./assets/3.jpg",
  },
  {
    title: "🌸 Mong cậu luôn vui",
    text: "Mong nụ cười của cậu sẽ luôn xuất hiện thật nhiều, không chỉ trong đêm Trung Thu mà cả những ngày bình thường.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌕 Ánh trăng",
    text: "Trăng đêm nay có thể rất đẹp, nhưng hy vọng cậu vẫn tìm được một lý do để mỉm cười đẹp hơn cả ánh trăng.",
    img: "./assets/2.jpg",
  },
  {
    title: "💗 Điều nhỏ bé",
    text: "Đôi khi hạnh phúc chẳng cần điều gì quá lớn, chỉ cần có một người thật lòng quan tâm đến mình là đủ.",
    img: "./assets/3.jpg",
  },
  {
    title: "🎑 Đêm Trung Thu",
    text: "Chúc cậu một đêm Trung Thu thật dịu dàng, có ánh trăng, có tiếng cười và có thật nhiều kỷ niệm đẹp.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌷 Gửi một chút dịu dàng",
    text: "Mong những mệt mỏi trong lòng cậu sẽ nhẹ đi, để đêm nay chỉ còn lại sự bình yên và những điều khiến cậu vui.",
    img: "./assets/2.jpg",
  },
  {
    title: "⭐ Ngôi sao nhỏ",
    text: "Giữa hàng ngàn ánh sao trên bầu trời, mong cậu luôn nhớ rằng mình cũng là một người rất đặc biệt.",
    img: "./assets/3.jpg",
  },
  {
    title: "🏮 Chiếc đèn đỏ",
    text: "Chiếc đèn này mang theo một lời chúc nhỏ: mong mọi con đường cậu đi qua đều có ánh sáng dẫn lối.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌙 Bình yên nhé",
    text: "Mong những ngày sắp tới của cậu sẽ thật nhẹ nhàng, ít muộn phiền và có nhiều khoảnh khắc khiến cậu hạnh phúc.",
    img: "./assets/2.jpg",
  },
  {
    title: "💫 Một lời chúc",
    text: "Chúc cậu luôn đủ mạnh mẽ để bước tiếp, đủ dịu dàng để yêu thương và đủ may mắn để gặp những điều tốt đẹp.",
    img: "./assets/3.jpg",
  },
  {
    title: "🌹 Người đặc biệt",
    text: "Có những người bước vào cuộc đời mình rất bình thường, nhưng rồi chẳng biết từ lúc nào lại trở thành một phần rất đặc biệt.",
    img: "./assets/1.jpg",
  },
  {
    title: "☁️ Những ngày phía trước",
    text: "Mong những ngày phía trước sẽ đối xử thật dịu dàng với cậu, để cậu luôn có lý do tin rằng cuộc sống này rất đáng yêu.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌕 Dưới ánh trăng",
    text: "Nếu có thể giữ lại một khoảnh khắc của đêm nay, mình mong đó sẽ là khoảnh khắc cậu mỉm cười dưới ánh trăng.",
    img: "./assets/3.jpg",
  },
  {
    title: "💌 Một lá thư nhỏ",
    text: "Không biết cậu có nhận ra không, nhưng có một người luôn mong cậu được vui vẻ, bình an và hạnh phúc.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌸 Mong ước",
    text: "Mong những điều cậu chưa nói thành lời sẽ có ngày được thực hiện, và những điều cậu đang chờ đợi sẽ sớm tìm đến.",
    img: "./assets/2.jpg",
  },
  {
    title: "✨ Đêm thật đẹp",
    text: "Đêm nay trăng sáng, đèn lung linh và mọi thứ thật đẹp. Nhưng điều mình mong nhất vẫn là cậu có một đêm thật vui.",
    img: "./assets/3.jpg",
  },
  {
    title: "💖 Gần bên nhau",
    text: "Có lẽ điều hạnh phúc nhất không phải là đi đến một nơi thật đẹp, mà là được ở bên một người khiến mình cảm thấy bình yên.",
    img: "./assets/1.jpg",
  },
  {
    title: "🎐 Một chút nhớ",
    text: "Trung Thu là mùa của đoàn viên. Và giữa những ánh đèn lung linh này, mình chợt thấy nhớ một người.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌙 Nếu cậu biết",
    text: "Nếu cậu biết có một người luôn âm thầm quan tâm đến cậu, liệu cậu có mỉm cười không?",
    img: "./assets/3.jpg",
  },
  {
    title: "🏮 Chiếc đèn thứ hai",
    text: "Mình gửi vào chiếc đèn này một chút yêu thương, một chút nhớ nhung và thật nhiều lời chúc dành cho cậu.",
    img: "./assets/1.jpg",
  },
  {
    title: "💗 Điều muốn nói",
    text: "Có những lời không dễ nói thành câu, nên mình gửi chúng vào những chiếc đèn để cậu tự mình khám phá.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌕 Trăng và cậu",
    text: "Người ta thường nói trăng Trung Thu là đẹp nhất. Nhưng với mình, khoảnh khắc cậu vui mới là điều đẹp nhất.",
    img: "./assets/3.jpg",
  },
  {
    title: "💌 Lá thư cuối",
    text: "Nếu cậu đã mở đến chiếc đèn này, thì có lẽ cậu đã đọc hết những điều mình muốn gửi.",
    img: "./assets/1.jpg",
  },
  {
    title: "❤️ Một điều thật lòng",
    text: "Mình không biết tương lai sẽ như thế nào, nhưng mình biết rằng hiện tại mình rất trân trọng sự xuất hiện của cậu trong cuộc đời mình.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌷 Cảm ơn cậu",
    text: "Cảm ơn cậu vì đã xuất hiện, vì những khoảnh khắc vui vẻ và vì đã khiến những ngày bình thường trở nên đặc biệt hơn.",
    img: "./assets/3.jpg",
  },
  {
    title: "✨ Điều đặc biệt",
    text: "Có thể với thế giới cậu chỉ là một người bình thường, nhưng trong thế giới của một người nào đó, cậu lại là cả một bầu trời.",
    img: "./assets/1.jpg",
  },
  {
    title: "🌙 Một mùa trăng nữa",
    text: "Mong rằng sau này, mỗi mùa Trung Thu đến, chúng ta vẫn còn nhớ về những điều đẹp đẽ đã từng dành cho nhau.",
    img: "./assets/2.jpg",
  },
  {
    title: "💞 Mong chúng ta",
    text: "Mong những khoảng cách sẽ dần ngắn lại, những hiểu lầm sẽ được bỏ qua và những người thương nhau sẽ luôn tìm được cách ở bên nhau.",
    img: "./assets/3.jpg",
  },
  {
    title: "🌸 Dịu dàng",
    text: "Nếu cuộc sống đôi khi quá mệt mỏi, hãy nhớ rằng vẫn có những người mong cậu được bình yên và luôn muốn nhìn thấy nụ cười của cậu.",
    img: "./assets/1.jpg",
  },
  {
    title: "🏮 Đèn và trăng",
    text: "Những chiếc đèn rồi sẽ bay xa, ánh trăng rồi sẽ đổi khác, nhưng những kỷ niệm đẹp thì mong rằng sẽ luôn ở lại.",
    img: "./assets/2.jpg",
  },
  {
    title: "💗 Một chút thương",
    text: "Có một chút nhớ trong ánh trăng, một chút thương trong chiếc đèn và rất nhiều điều chưa kịp nói thành lời.",
    img: "./assets/3.jpg",
  },
  {
    title: "🌕 Điều mình mong",
    text: "Mình không mong cậu có một cuộc sống hoàn hảo. Mình chỉ mong mỗi ngày cậu đều có ít nhất một lý do để mỉm cười.",
    img: "./assets/1.jpg",
  },
  {
    title: "💖 Nếu có thể",
    text: "Nếu có thể chọn một điều ước cho riêng mình, có lẽ mình sẽ ước những người mình thương luôn được bình an và hạnh phúc.",
    img: "./assets/2.jpg",
  },
  {
    title: "🌙 Gửi người mình thương",
    text: "Trung Thu năm nay mình chỉ muốn gửi đến cậu một lời chúc thật đơn giản: hãy luôn vui, luôn bình an và đừng quên rằng cậu rất đáng được yêu thương.",
    img: "./assets/3.jpg",
  },
  {
    title: "❤️ Điều cuối cùng",
    text: "Nếu những chiếc đèn này có thể mang theo một lời nhắn đến cậu, thì mình muốn chiếc đèn cuối cùng nói rằng: cảm ơn cậu đã đến bên mình. Mong rằng dù sau này thời gian có trôi qua bao lâu, chúng ta vẫn sẽ nhớ về nhau bằng những điều thật đẹp.",
    img: "./assets/1.jpg",
  },
  {
    title: "💝 Gửi cậu, người đặc biệt nhất",
    text: "Nếu cậu đang đọc đến đây, thì đây chính là điều mình muốn nói nhất. Mình không biết tương lai sẽ đưa chúng ta đi đến đâu, nhưng mình thật sự mong rằng trên hành trình ấy, mình vẫn có thể được ở bên cậu, cùng cậu đón thêm thật nhiều mùa Trung Thu nữa. Không cần điều gì quá lớn lao, chỉ cần có cậu bên cạnh, một ánh trăng, một chiếc đèn và một khoảnh khắc bình yên cũng đã đủ để mình cảm thấy hạnh phúc. Chúc cậu luôn được yêu thương, luôn mỉm cười và nếu có thể... hãy cho mình một cơ hội để trở thành người khiến cậu mỉm cười thật nhiều. ❤️",
    img: "./assets/2.jpg",
  },
];
